...
(1, 'John Doe', 'admin@gmail.com', '$2y$10$gwtELxtS22mJpgOC.XaUvOt0BDkc71lFIjAVERNO//MMv4Eyz6oaG', '', 'user-1.jpg', NULL, '2021-06-06 20:17:47');
...
(1, 'REGISTRATION', 'Registration', NULL, NULL),
(2, 'LOGIN', 'Login', NULL, NULL),
(3, 'DASHBOARD', 'Dashboard', NULL, NULL),
(4, 'EMAIL_ADDRESS', 'Email Address', NULL, NULL),
(5, 'TERM_AND_CONDITIONS', 'Terms and Conditions', NULL, NULL),
(6, 'PRIVACY_POLICY', 'Privacy Policy', NULL, NULL),
(7, 'SUBMIT', 'Submit', NULL, NULL),
(8, 'HOME', 'Home', NULL, NULL),
(9, 'SERVICES', 'Services', NULL, NULL),
(10, 'DESTINATIONS', 'Destinations', NULL, NULL),
(11, 'PACKAGES', 'Packages', NULL, NULL),
(12, 'PAGES', 'Pages', NULL, NULL),
(13, 'ABOUT_US', 'About Us', NULL, NULL),
(14, 'OUR_TEAM', 'Our Team', NULL, NULL),
(15, 'TESTIMONIAL', 'Testimonial', NULL, NULL),
(16, 'FAQ', 'FAQ', NULL, NULL),
(17, 'BLOG', 'Blog', NULL, NULL),
(18, 'CONTACT', 'Contact', NULL, NULL),
(19, 'SEARCH_HERE', 'Search Here', NULL, NULL),
(20, 'CATEGORIES', 'Categories', NULL, NULL),
(21, 'RECENT_NEWS', 'Recent News', NULL, NULL),
(22, 'PAYMENT_HISTORY', 'Payment History', NULL, NULL),
(23, 'UPDATE_PROFILE', 'Update Profile', NULL, NULL),
(24, 'UPDATE_PASSWORD', 'Update Password', NULL, NULL),
(25, 'LOGOUT', 'Logout', NULL, NULL),
(26, 'COMPLETED_ORDERS', 'Completed Orders', NULL, NULL),
(27, 'PENDING_ORDERS', 'Pending Orders', NULL, NULL),
(28, 'PROFILE_DATA_UPDATE_WARNING', 'Please update your profile information and complete profile before to purchase package.', NULL, NULL),
(29, 'VIEW_ALL_PAYMENT', 'View All Payments', NULL, NULL),
(30, 'SERIAL', 'Serial', NULL, NULL),
(31, 'ORDER_NO', 'Order No', NULL, NULL),
(32, 'PAID_AMOUNT', 'Paid Amount', NULL, NULL),
(33, 'PACKAGE', 'Package', NULL, NULL),
(34, 'DESTINATION', 'Destination', NULL, NULL),
(35, 'PAYMENT_METHOD', 'Payment Method', NULL, NULL),
(36, 'PAYMENT_STATUS', 'Payment Status', NULL, NULL),
(37, 'ACTION', 'Action', NULL, NULL),
(38, 'SEE_DETAIL', 'See Detail', NULL, NULL),
(39, 'ORDER_DETAIL', 'Order Detail', NULL, NULL),
(40, 'PAYMENT_DATE', 'Payment Date', NULL, NULL),
(41, 'TRANSACTION_ID', 'Transaction ID', NULL, NULL),
(42, 'CARD_LAST4_DIGIT', 'Card Last 4 Digits', NULL, NULL),
(43, 'CARD_EXP_MONTH', 'Card Expiry Month', NULL, NULL),
(44, 'CARD_EXP_YEAR', 'Card Expiry Year', NULL, NULL),
(45, 'BACK_TO_PREVIOUS', 'Back to Previous', NULL, NULL),
(46, 'UPDATE', 'Update', NULL, NULL),
(47, 'NAME', 'Name', NULL, NULL),
(48, 'PHONE', 'Phone', NULL, NULL),
(49, 'COUNTRY', 'Country', NULL, NULL),
(50, 'ADDRESS', 'Address', NULL, NULL),
(51, 'STATE', 'State', NULL, NULL),
(52, 'CITY', 'City', NULL, NULL),
(53, 'ZIP_CODE', 'Zip Code', NULL, NULL),
(54, 'NEW_PASSWORD', 'New Password', NULL, NULL),
(55, 'PASSWORD', 'Password', NULL, NULL),
(56, 'TRAVELLER_LOGIN', 'Traveller Login', NULL, NULL),
(57, 'FORGET_PASSWORD', 'Forget Password', NULL, NULL),
(58, 'NEW_USER_MAKE_REGISTRATION', 'New User? Make Registration', NULL, NULL),
(59, 'TRAVELLER_REGISTRATION', 'Traveller Registration', NULL, NULL),
(60, 'MAKE_REGISTRATION', 'Make Registration', NULL, NULL),
(61, 'EXISTING_USER_GO_TO_LOGIN', 'Existing User? Go to Login Page', NULL, NULL),
(62, 'RESET_PASSWORD', 'Reset Password', NULL, NULL),
(63, 'BACK_TO_LOGIN_PAGE', 'Back to Login Page', NULL, NULL),
(64, 'READ_MORE', 'Read More', NULL, NULL),
(65, 'SEE_ALL_DESTINATIONS', 'See All Destinations', NULL, NULL),
(66, 'ALL_SERVICES', 'All Services', NULL, NULL),
(67, 'SHARE_NOW', 'Share Now', NULL, NULL),
(68, 'PERSON', 'Person', NULL, NULL),
(69, 'AVAILABLE_FOR_BOOKING', 'Available For Booking', NULL, NULL),
(70, 'NOT_AVAILABLE_FOR_BOOKING', 'Not Available For Booking', NULL, NULL),
(71, 'INTRODUCTION', 'Introduction', NULL, NULL),
(72, 'EXPERIENCE', 'Experience', NULL, NULL),
(73, 'WEATHER', 'Weather', NULL, NULL),
(74, 'HOTEL', 'Hotel', NULL, NULL),
(75, 'TRANSPORTATION', 'Transport', NULL, NULL),
(76, 'CULTURE', 'Culture', NULL, NULL),
(77, 'TOUR_DATES', 'Tour Dates', NULL, NULL),
(78, 'TOUR_START_DATE', 'Tour Start Date', NULL, NULL),
(79, 'TOUR_END_DATE', 'Tour End Date', NULL, NULL),
(80, 'LAST_BOOKING_DATE', 'Last Booking Date', NULL, NULL),
(81, 'TOUR_DESCRIPTION', 'Tour Description', NULL, NULL),
(82, 'BOOK_NOW', 'Book Now', NULL, NULL),
(83, 'TOTAL_PRICE_PER_PERSON', 'Total Price (per Person)', NULL, NULL),
(84, 'TOTAL_PERSONS', 'Total Persons', NULL, NULL),
(85, 'TOTAL_PRICE', 'Total Price', NULL, NULL),
(86, 'BOOK_YOUR_SEAT', 'Book Your Seat', NULL, NULL),
(87, 'CAN_NOT_BOOK_DATE_OVER_MESSAGE', 'You can not book your seat. Date is over.', NULL, NULL),
(88, 'MORE_INFORMATION', 'More Information', NULL, NULL),
(89, 'TOUR_PHOTOS', 'Tour Photos', NULL, NULL),
(90, 'TOUR_VIDEOS', 'Tour Videos', NULL, NULL),
(91, 'TOUR_INFORMATION', 'Tour Information', NULL, NULL),
(92, 'ITINERARY', 'Itinerary', NULL, NULL),
(93, 'POLICY', 'Policy', NULL, NULL),
(94, 'DETAIL_LOCATION', 'Detail Location', NULL, NULL),
(95, 'ADDRESS_IN_MAP', 'Address in Map', NULL, NULL),
(96, 'PAYMENT', 'Payment', NULL, NULL),
(97, 'BOOKING_DETAIL', 'Booking Detail', NULL, NULL),
(98, 'PACKAGE_NAME', 'Package Name', NULL, NULL),
(99, 'SUBTOTAL', 'Subtotal', NULL, NULL),
(100, 'TOTAL', 'Total', NULL, NULL),
(101, 'MAKE_PAYMENT', 'Make Payment', NULL, NULL),
(102, 'GO_TO_PROFILE_UPDATE_PAGE', 'Go to profile update page', NULL, NULL),
(103, 'PAY_WITH_PAYPAL', 'Pay with PayPal', NULL, NULL),
(104, 'PAY_WITH_STRIPE', 'Pay with Stripe', NULL, NULL),
(105, 'DETAIL', 'Detail', NULL, NULL),
(106, 'TEAM_MEMBERS', 'Team Members', NULL, NULL),
(107, 'SEARCH_BY_COLON', 'Search By:', NULL, NULL),
(108, 'NO_RESULT_FOUND', 'No Result is Found', NULL, NULL),
(109, 'CATEGORY_COLON', 'Category:', NULL, NULL),
(110, 'CONTACT_FORM', 'Contact Form', NULL, NULL),
(111, 'MESSAGE', 'Message', NULL, NULL),
(112, 'CONTACT_INFORMATION', 'Contact Information', NULL, NULL),
(113, 'COMMENTS', 'Comments', NULL, NULL),
(114, 'ERROR_EMAIL_EMPTY', 'Email address can not be empty', NULL, NULL),
(115, 'ERROR_EMAIL_INVALID', 'Email address is invalid', NULL, NULL),
(116, 'ERROR_PASSWORD_EMPTY', 'Password can not be empty', NULL, NULL),
(117, 'ERROR_RECAPTCHA', 'You must have to input recaptcha correctly', NULL, NULL),
(118, 'ERROR_EMAIL_NOT_FOUND', 'Email address is not found', NULL, NULL),
(119, 'ERROR_PASSWORD_WRONG', 'Password is Wrong', NULL, NULL),
(120, 'ERROR_TRAVELLER_INACTIVE', 'Traveller is not active yet', NULL, NULL),
(121, 'SUCCESS_PASSWORD_RESET_SUBMIT', 'Please check your email to get password reset information', NULL, NULL),
(122, 'ERROR_NAME_EMPTY', 'Name can not be empty', NULL, NULL),
(123, 'ERROR_EMAIL_EXIST', 'Email address already exists', NULL, NULL),
(124, 'SUCCESS_REGISTRATION_SUBMIT', 'Please check your email to verify your registration. Check your spam folder too.', NULL, NULL),
(125, 'SUCCESS_REGISTRATION_VERIFY', 'Registration is completed. You can now login.', NULL, NULL),
(126, 'ERROR_PHONE_EMPTY', 'Phone number can not be empty', NULL, NULL),
(127, 'ERROR_COUNTRY_EMPTY', 'Country can not be empty', NULL, NULL),
(128, 'ERROR_ADDRESS_EMPTY', 'Address can not be empty', NULL, NULL),
(129, 'ERROR_STATE_EMPTY', 'State can not be empty', NULL, NULL),
(130, 'ERROR_CITY_EMPTY', 'City can not be empty', NULL, NULL),
(131, 'ERROR_ZIP_EMPTY', 'Zip Code can not be empty', NULL, NULL),
(132, 'SUCCESS_PROFILE_UPDATE', 'Profile is updated successfully', NULL, NULL),
(133, 'SUCCESS_PASSWORD_UPDATE', 'Password is updated successfully', NULL, NULL),
(134, 'SUCCESS_PASSWORD_RESET', 'Please check your email for reset instruction', NULL, NULL),
(135, 'SUCCESS_SUBSCRIBER_SUBMIT', 'To activate your subscription please check your email and follow instruction there.', NULL, NULL),
(136, 'SUCCESS_SUBSCRIBER_VERIFY', 'Subscription is successful. Thank you.', NULL, NULL),
(137, 'ERROR_MESSAGE_EMPTY', 'Message can not be empty', NULL, NULL),
(138, 'SUCCESS_CONTACT_FORM', 'Message is sent successfully! Admin will contact you soon', NULL, NULL),
(139, 'PRICE', 'Price', NULL, NULL),
(140, 'CURRENCY', 'Currency', NULL, NULL);
